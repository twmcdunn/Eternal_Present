package src.sound.sound_design_experiments;
...
public class FFT2 {
    ...
    public static void convTest() {
        ...
        // WaveWriter.SAMPLE_RATE];//ReadSound.readSoundDoubles("cathedral.wav");
         sig1 = Arrays.copyOf(sig1, (int)Math.rint(WaveWriter.SAMPLE_RATE * secLength));
        ...
        WaveWriter ww = new WaveWriter("resources/other_samples/lowSound");
